...
using System.Net;
using System.Web;
using static Translate.Lib.TranslateFileDal;
...
namespace Translate.Lib
{
    public class BDat
    {
        ...
        public void Translate(string binFilePath, string lang)
        {
            bool is64 = Path.GetFileNameWithoutExtension(binFilePath).Contains("64");
            ...
            BinaryWriter bw = new BinaryWriter(File.Open(binFilePath, FileMode.Create));
    ...
    public class TranslateReader
    {
        ...
        public bool CanTran(string alias)
        {
            ...
            //    return false;
            //removed to enable emote commands translation
            ...
            //    return false;
            //"fix ss crash"
            if (alias.IndexOf("UI.ItemTooltip.SetItemEffect.SkillModifyByEquipment") == 0)
                return false;
            return true;
        }
        public void MergeTranslation(TranslateReader translated, string savePath)
        {
            ...
            foreach (XmlNode xNode in xNodeList)
            {
                ...
                {
#if DEBUG
                    Console.Write("MergeTranslation: {0}\r", alias);
#endif
                }
...
#if DEBUG
            Console.Write("savePath: {0}\r", savePath);
#endif
